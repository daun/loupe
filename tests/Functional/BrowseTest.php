...
final class BrowseTest extends TestCase
{
    ...
    /**
     * Browsing only the primary key is answered without reading the documents, so it has to agree with a
     * projection that goes through the regular pipeline.
     */
    ...
    public function testBrowsePrimaryKeyOnlyKeepsIdTypeAndGaps(): void
    {
        ...
        // Leading zeros and digit-only strings must not be turned into numbers.
        ...
        // A filter must fall back to the regular pipeline.
        $result = $loupe->browse(
